...
def normalize_eruptions(obj):
    ...
    for f in obj.get('features',[]):
        ...
        p.update({'Volcano_Number':pick(p,'Volcano_Number','VolcanoNumber','volcano_number','VolcanoNo'),'Volcano_Name':pick(p,'Volcano_Name','VolcanoName','volcano_name'),'Eruption_Number':pick(p,'Eruption_Number','EruptionNumber','eruption_number'),'Eruption_Category':pick(p,'Activity_Type','Eruption_Category','EruptionCategory','eruption_category','EruptionCategoryName'),'Start_Date':pick(p,'Start_Date','StartDate','start_date'),'Start_Year':pick(p,'StartDateYear','Start_Year','StartYear','start_year'),'Start_Month':pick(p,'StartDateMonth','Start_Month','StartMonth','start_month'),'Start_Day':pick(p,'StartDateDay','Start_Day','StartDay','start_day'),'Start_Year_Uncertainty':pick(p,'StartDateYearUncertainty','Start_Year_Uncertainty','StartYearUncertainty'),'Start_Day_Uncertainty':pick(p,'StartDateDayUncertainty','Start_Day_Uncertainty','StartDayUncertainty'),'End_Date':pick(p,'End_Date','EndDate','end_date'),'End_Year':pick(p,'EndDateYear','End_Year','EndYear','end_year'),'End_Month':pick(p,'EndDateMonth','End_Month','EndMonth','end_month'),'End_Day':pick(p,'EndDateDay','End_Day','EndDay','end_day'),'VEI':pick(p,'ExplosivityIndexMax','VEI','Vei','vei'),'VEI_Modifier':pick(p,'ExplosivityIndexModifier','VEI_Modifier')})
